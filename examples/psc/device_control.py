...
def main():
    ...
    subparsers = parser.add_subparsers(required=True, dest="command", help="Device command help")
    ...
    group.add_argument("--on", action="store_true", help="Turn background scanning on")
    group.add_argument("--off", action="store_true", help="Turn background scanning off")    
    
    bypass_p = subparsers.add_parser("bypass", help="Set bypass mode")
    toggle = bypass_p.add_mutually_exclusive_group(required=True)
    group.add_argument("--on", action="store_true", help="Enable bypass mode")
    group.add_argument("--off", action="store_true", help="Disable bypass mode")
    ...
    group.add_argument("--on", action="store_true", help="Enable quarantine mode")
    group.add_argument("--off", action="store_true", help="Disable quarantine mode")
    ...
    sensorv_p = subparses_parser("sensor_version", help="Update sensor version for node")
